...
function PrivacyPolicy() {
  return (
    <section className="w-full flex items-center justify-center bg-transparent py-4">
      <div className="w-full flex flex-col items-center justify-center">
        <h1 className="pt-4 pb-2 text-base font-semibold leading-10 text-center text-slate-gray uppercase select-none lg:text-2xl md:text-3xl">
          Privacy Policy for satta1
        </h1>
        <div className="w-full flex flex-col items-start justify-start">
          <p>
            At https://satta1.online/, accessible from https://satta1.online/,
            one of our main priorities is the privacy of our visitors. This
            Privacy Policy document contains types of information that is
            collected and recorded by https://satta1.online/ and how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            that they shared and/or collect in https://satta1.online/.{" "}
          </p>
          <p>
        ...
        <div className="w-full flex flex-col items-start justify-start mt-2">
          ...
          <p>
            https://satta1.online/ follows a standard procedure of using log
        ...
        <div className="w-full flex flex-col items-start justify-start mt-2">
          ...
          <p>
            Like any other website, https://satta1.online/ uses 'cookies'. These
        ...
        <div className="w-full flex flex-col items-start justify-start mt-2">
          ...
          <p>
            ...
            advertising partners of https://satta1.online/.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on
            https://satta1.online/, which are sent directly to users' browser.
          ...
          <p>
            Note that https://satta1.online/ has no access to or control over
        ...
        <div className="w-full flex flex-col items-start justify-start mt-2">
          ...
          <p>
            https://satta1.online/'s Privacy Policy does not apply to other
          ...
          <h6>
            <em>CCPA Privacy Rights (Do Not Sell My Personal Information)</em>
          </h6>
          <p>
          ...
          <h6>
            <em>GDPR Data Protection Rights</em>
          </h6>
          <p>
        ...
        <div className="w-full flex flex-col items-start justify-start mt-2">
          ...
          <p>
            https://satta1.online/ does not knowingly collect any Personal
